...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let likeImages = document.querySelectorAll('.like-img2');
	let likeNums = document.querySelectorAll('.like-num');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let likeImages = document.querySelectorAll('.like-img3');
	let likeNums = document.querySelectorAll('.like-num');
        ...
        likeImage.addEventListener('click', function() {
          ...
          console.log("post_id:", post_id, "member_id:", member_id); //값 확인
			...
			if (member_id && !isNaN(member_id)) {
			 ...
			 // 값이 안전하게 변환된 후에 fetch 요청 보내기
            fetch('http://localhost:9071/fg?post_id=' + post_id + '&member_id=' + member_id, {
           		method: 'GET',
	            headers: {
	                'Content-Type': 'application/json',
	                // You can add more headers if needed
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let likeImages = document.querySelectorAll('.like-img4');
	let likeNums = document.querySelectorAll('.like-num');
